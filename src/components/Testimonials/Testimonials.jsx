...
const Testimonials = () => {
  ...
  return (
    <>
      <div className="py-10 dark:text-letter">
              ...
              {testimonialData.map(({ id, name, text, img }) => {
                return (
                  <div key={id} className="my-6">
                    {/* card */}
                    <div className="flex flex-col sm:flex-row gap-5 md:gap-14 p-4 mx-4 rounded-xl dark:bg-complex relative">
                      <img
                        src={img}
                        alt=""
                      ...
                      <div className="space-y-4">
                        <p className="text-slate text-secondary/80 dark:text-letter/80 xl:pr-40">
                          “{text}”
                        </p>
                        <h1 className="text-xl font-bold dark:text-tertiary">
                          {name}
                        </h1>
                      </div>
